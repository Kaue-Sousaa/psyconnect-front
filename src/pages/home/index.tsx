...
import imgMisterioSonho from "../../assets/omisteriodossonho.png";
import imgWordBubbles from "../../assets/wordbubbles.png";
...
export default function Home() {
  ...
  type IconName = "accessibility" | "face" | "favorite" | "psychology";

  const highlightCards = [
    {
      title: "Math vs Undead",
      image: imgMathUndead,
      description:
    ...
    {
      title: "O Mistério dos Sonhos",
      image: imgMisterioSonho,
      description:
        "Para ajudar os guardiões, vocês precisarão executar algumas missões para chegar ao objetivo final. A criança estará envolvida em diversas funções cognitivas. Em muitos momentos é preciso ler, executar comandos, raciocinar, entender as regras e estar muito atento ao objetivo final.",
    },
    {
      title: "Word Bubbles",
      image: imgWordBubbles,
      description:
        "Desenvolve a aprendizagem da escrita pois possibilita a criança envolver-se em deduções de escrita. Junte bolinhas e forme palavras. Um jogo com atrativos visuais, auditivos e táteis que desperta grande interesse nos pequenos. Disponível na Apple Store (smartphones e tablets) e na Playstore (uma versão similar). Gratuito",
    },
  ];
